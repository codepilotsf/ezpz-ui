...
<style>
	...
	select {
		...
		border-color: var(--ui-select-border-color, var(--ui-border-color, var(--ui-midtone, #d2d6dc)));
	...
	select:focus {
		...
		outline-offset: var(--ui-select-outline-offset, var(--ui-outline-offset, none));
